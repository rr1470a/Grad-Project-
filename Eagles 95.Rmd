...
of March 12, first quarter payroll, and annual payroll. Since the data
is collected on the county level, all variables used in our analysis are
also presented at the county level.

### Data Exploration and Visualization: 

For our analysis we worked on identifying the patterns in the business
industries in the US as compared to the DMV area. Most of our
visualization juxtaposes the patterns found in DMV to the ones found all
over the US. Specifically, we created visualizations to asses and
compare the Average Annual Payroll Per Employee in the top 10 industries
in the DMV and in the US. Additionally, we tried to identify the top ten
industries that employ the most number of employees, the top ten
industries that have the most number of establishments and, the state
level divisions of those establishments. This analysis helped us
identify the dominant industries, states, and counties in the US, and in
the DMV area in terms of the annual payroll, number of employees and
